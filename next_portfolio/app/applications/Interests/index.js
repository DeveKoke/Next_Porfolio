...
const CiTec = new Interest('Ciencia y Tecnología', 
                            'Siempre digo que tengo una parte de científico frustrado. Aunque fui por Ciencias Sociales, siempre me interesaron las ciencias puras. Por ejemplo, me maravilla la astronomía, y todo el universo, el sistema solar, la física y las fuerzas que rigen el cosmos...incluso tengo mi propio telescopio! Me fascina la magia que envuelve a la biología y el cuerpo humano. Además, me atraen las tecnologías y me genera curiosidad cuando veo nuevas herramientas que en seguida quiero probar e implementar en algun proyecto nuevo.');
...
const Sports = new Interest('Deportes',
                            'Me van mucho los deportes y la actividad física, a ser posible en montaña o en el agua. Siempre que puedo me doy una escapadita a montaña o playa para desconectar y practicarlos. Lamentablemente los deportes del motor (automovilismo sobre todo), de mis favoritos, no puedo practicarlos tanto como me gustaría.' );
...
const Music = new Interest('Música',
                            'Ante todo fan de Queen, Celtas Cortos y The Beatles.');
const Books = new Interest('Libros', 
                            'Reconozco que no leo muchas novelas pero si leo alguna prefiero el género de la fantasía. Sin embargo, sobre todo me atraen ensayos o temáticos sobre historia y ciencia. <cite>Sapiens</cite>, de Yuval Noah Harari, muy recomendable. También tengo mi pequeña colección de comics, de Marvel, por supuesto. ')



export const hobbies = [CiTec, History, Fotography, Traveling, Sports, Cinema, Gardening, Music, Books];
