    ...
    <>
      <section className={styles.aboutWrapper} id='about'>
          <article className={styles.aboutContainer}>
            <h2 className={styles.h1About} >Sobre mí</h2>
            ...
            <p>Dentro del sector educativo siempre me llamaron la atención las nuevas tecnologías aplicadas a la educación y, cuando llegó 
              ...
              <p>Empecé por mi cuenta, haciendo mis pequeños proyectos con HTML, CSS y JavaScript. En seguida vi que esto tenía mucho más, y que había tanto por aprender que necesitaba un impulso para abarcar con todo lo que quería aprender.</p>
              <p>El año pasado tuve la oportunidad de realizar un bootcamp Full-Stack en<i><a className={styles.links} href="https://www.thebridge.tech/bootcamps/bootcamp-fullstack-developer" target="_blank">The Bridge</a></i> y después de 4 meses intensos de formación, además de varios meses aprendiendo como autodidacta antes de dicho curso aprendí muchas tecnologías y formas de aplicar mis conocimientos al código y la lógica de programación. Pude ampliar conocimientos de JavaScript y maquetación con CSS y Sass, además de manejar bases de datos relacionales y no relacionales. También pude empezar mi inmersión en React, tecnología con la que he podido llevar a cabo algunos proyectos que puedes ver en mi perfil github. 
              ...
              en <i><a className={styles.links} href="https://www.qualentum.com/candidato/frontend-developer/metodologia-desarrollo-front/" target="_blank">Qualentum</a></i>, en conjunto con UNIR, como Frontend Developer. Aquí he podido ampliar conocimientos de CSS, Sass, React y conocer por primera vez el funcionamiento de NextJS. </p>
          </article>
      </section>
    </>
  );
